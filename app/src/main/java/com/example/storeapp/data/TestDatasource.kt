...
object TestDatasource {
    ...
    fun loadStoreItems(
        ...
        return listOf(
            StoreItem.testData(context, R.string.item_1_name, R.drawable.item1, R.string.item_description_1, 15.99, 1),
            StoreItem.testData(context, R.string.item_2_name, R.drawable.item2, R.string.item_description_2, 20.99, 2),
            StoreItem.testData(context, R.string.item_3_name, R.drawable.item3, R.string.item_description_3, 11.99, 3),
            StoreItem.testData(context, R.string.item_4_name, R.drawable.item4, R.string.item_description_4, 10.99, 4),
            StoreItem.testData(context, R.string.item_5_name, R.drawable.item5, R.string.item_description_5, 7.99, 5),
            StoreItem.testData(context, R.string.item_6_name, R.drawable.item6, R.string.item_description_6, 8.99, 6),
            StoreItem.testData(context, R.string.item_7_name, R.drawable.item7, R.string.item_description_7, 9.99, 7),
            StoreItem.testData(context, R.string.item_8_name, R.drawable.item8, R.string.item_description_8, 5.99, 8),
            StoreItem.testData(context, R.string.item_9_name, R.drawable.item9, R.string.item_description_9, 4.99, 9),
            StoreItem.testData(context, R.string.item_10_name, R.drawable.item10, R.string.item_description_10, 9.99, 10)
        )
    }
